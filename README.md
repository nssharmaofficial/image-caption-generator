...
**Note:** After correcting mistakes in the traning, I have not yet trained a new model. These examples were done by using the model trained on the Flickr8k dataset. 
